proc ps7_pll_init_data {} {
	# write 0xDF0D to unlock slcr write protection
	...
	# write 0x767B to slcr lock register to lock slcr register access
...
proc ps7_mio_init_data {} {
	mwr -force 0XF8000008 0x0000DF0D
    	...
    	# mask_write 0XF80007B8 0x00003FFF 0x00001281
    	# mask_write 0XF80007BC 0x00003FFF 0x00001281
    	# mask_write 0XF80007C0 0x00003FFF 0x00001281
    	# mask_write 0XF80007C4 0x00003FFF 0x00001281
    	# mask_write 0XF80007C8 0x00003FFF 0x00001281
    	# mask_write 0XF80007CC 0x00003FFF 0x00001281
